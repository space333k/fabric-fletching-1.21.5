...
import com.space333.fletching.item.custom.SpecialArrowsItem;
...
public class ModItems {
    public static final Item SPECIAL_ARROW = registerArrow("special_arrow");

    private static Item registerArrow(String name) {
        return Registry.register(Registries.ITEM, Identifier.of(Fletching.MOD_ID, name), new SpecialArrowsItem(new Item.Settings()
